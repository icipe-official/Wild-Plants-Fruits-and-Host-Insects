...
export default async function handler(req, res) {
    ...
    const flattenedData = data.map((plant) => {
        return {
          ...
          stem_type:plant.plants_woody_herbaceous.map((y=>y.woody_herbaceous.type_of_stem)).join(','),
        //   type_of_stem: plant.plants_woody_herbaceous.woody_herbaceous.map((t)=>t.tree_type)
          latex_description: plant.plants_latex.map((latex=>latex.latex.latex_description)).join(',')
      ...
      console.log(data.map((plant=>plant.plants_woody_herbaceous.map((y=>y.woody_herbaceous.type_of_stem)))))
