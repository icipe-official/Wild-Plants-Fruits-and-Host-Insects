...
export default function DipteraTephridiae({ diptera_tephritideae_data, other_diptera_data }) {
...
const handleClick = (genus) => {
  ...
  Router.push({
    ...
    query: { genus: genus.insect_genera.genus_name, species_name:genus.species_name}
  });
};
