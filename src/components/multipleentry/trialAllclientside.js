...
//   if (data) {
//     if (checkedStatePlantType.length !== data.plant_types.length) {
//       setCheckedStatePlantType(new Array(data.plant_types.length).fill(false));
//     }

//     console.log(checkedStatePlantType);

//     // render your component with the data and checkedStatePlantType states
//   }
// }
...
export default function QuerySelect() {
  ...
  if (data) {
    ...
    // manage states of checked spines
