...
export default function QuerySelect() {
  ...
  if (data && data.length > 0) {
    const uniqueData = Array.from(
      ...
      return data.find((item) => item.insect_genera.genus_name === name);
    });
    ...
    const handleOnChangePlantType = (position) => {
      const updatedCheckedStatePlantType = plant_type.map((item, index) =>
    ...
    const handleOnChangePlantSpnines = (position) => {
      const updatedCheckedStatePlantSpnines = plant_spines.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangePlantLatex = (position) => {
      const updatedCheckedStatePlantLatex = plant_latex.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeFruitType = (position) => {
      const updatedCheckedStateFruitType = fruit_type.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeSize = (position) => {
      const updatedCheckedStateSize = fruit_size.map((item, index) =>
    ...
    const handleOnChangeColor = (position) => {
      const updatedCheckedStateColor = fruit.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeFruitShape = (position) => {
      const updatedCheckedStateFruitShape = shape.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeLeafType = (position) => {
      const updatedCheckedStateLeafType = leaf_type.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeLeafMargins = (position) => {
      const updatedCheckedStateLeafMargins = leaf_marg.map((item, index) =>
        position === index ? !item : item
      );
    ...
    const handleOnChangeLeafArrangement = (position) => {
      const updatedCheckedStateLeafArrangement = arrange.map((item, index) =>
        position === index ? !item : item
      );
