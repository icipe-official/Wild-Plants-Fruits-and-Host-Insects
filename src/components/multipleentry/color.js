...
const fruit_color_array= Array.from(fruit_color_data.fruit_color_data.fruit_color_data).map(specie =>(
...
const handleOnChange = (position) => {
  ...
  // setQuery.fruit[fr]
  const fruitSizeIndex=checkedState.flatMap((bool,index)=>bool? index:[]) //extract only true values index
            ...
            <div className="toppings-list-item">
              <div className="left-section">
                <input
                  ...
                  onChange={() => {handleOnChange(index),handleQuery(query)}}
                />
