...
export default function Groupcheckbox({plant_type_data,latex_data,spines_data,fruit_type_data,fruit_shape_data,fruit_color_data,fruit_size_data,
...
return(
  <Box sx={{display:'column'}}>
    <Box sx={{display:"flex",border: "1px solid #ccc", borderRadius: "4px", width:"100%",marginTop:1,height:280}}>
    <Box sx={{display:"flex"}}>
  ...
  <Box sx={{height: "220px",backgroundColor:'lightgrey', overflowY: "auto", border: "1px solid #ccc", borderRadius: "4px",width:'200px'}}>
    {plant_type_array.sort().map((type, index) =>(
      <FormGroup key={type}>
        <FormControlLabel            
          control={<Checkbox checked={checkedStatePlantType[index]} onChange={() => handleOnChangePlantType(index)}/>}
          label={type}
        />
      </FormGroup>
    ))}
...
<Box sx={{marginLeft:2}}>
  ...
  <Box sx={{height: "220px",backgroundColor:'lightgrey', overflowY: "auto", border: "1px solid #ccc", borderRadius: "4px",width:'200px',marginLeft:2}}>
    {plant_spines_array.sort().map((spine, index) =>(
      <FormGroup key={spine}>
        <FormControlLabel            
          control={<Checkbox checked={checkedStatePlantSpnines[index]} onChange={() => handleOnChangePlantSpnines(index)}/>}
          label={spine}
        />
      </FormGroup>
    ))}
...
<Box sx={{marginLeft:2}}>
  ...
  <Box sx={{height: "220px",backgroundColor:'lightgrey', overflowY: "auto", border: "1px solid #ccc", borderRadius: "4px",width:'200px',marginLeft:2}}>
    {plant_latex_array.sort().map((latex, index) =>(
      <FormGroup key={latex}>
        <FormControlLabel            
          control={<Checkbox checked={checkedStatePlantLatex[index]} onChange={() => handleOnChangePlantLatex(index)}/>}
          label={latex}
        />
      </FormGroup>
    ))}
    ...
    color='error'
     ...
     <Typography variant="subtitle1" sx={{color: "red"}}>
      Type
        ...
        <Box sx={{height: "220px",backgroundColor:'lightgrey', overflowY: "auto", border: "1px solid #ccc", borderRadius: "4px",width:'200px',marginLeft:0.5}}>
        {/* <Select style={{ width: "200px" }}> */}
        {fruit_type_array.sort().map((fruit, index) =>(
            <FormGroup key={fruit}>
                <FormControlLabel            
                    control={<Checkbox checked={checkedStateFruitType[index]} onChange={() => handleOnChangeFruitType(index)}/>}
                    label={fruit}/>
     ...
     <Typography variant="subtitle2" sx={{color: "red"}}>
      Shape
        ...
        {fruit_shape_array.sort().map((shape, index) =>(
            <FormGroup key={shape}>
                <FormControlLabel            
                    control={<Checkbox checked={checkedStateFruitShape[index]} onChange={() => handleOnChangeFruitShape(index)}/>}
                    label={shape}/>   
            </FormGroup>))}
        </Box>
        </Box>
 ...
 {fruit_size_array.map((size, index) => (
     ...
     <Box sx={{height: "220px",backgroundColor:'lightgrey', overflowY: "auto", border: "1px solid #ccc", borderRadius: "4px",width:'200px',marginLeft:2}}>
      {leaf_type_array.map((type, index) => (
        <FormGroup key={type}> 
            <FormControlLabel            
            control={<Checkbox checked={checkedStateLeafType[index]} onChange={() => handleOnChangeLeafType(index)}/>}
            label={type}/>
        </FormGroup>))}
        </Box>
        </Box>
     ...
     <Typography variant="subtitle2" sx={{color: "green"}}>
      ...
      {leaf_margins_array.map((margin, index) => (
        <FormGroup key={margin}> 
            <FormControlLabel            
            control={<Checkbox checked={checkedStateLeafMargins[index]} onChange={() => handleOnChangeLeafMargins(index)}/>}
            label={margin}/>
        </FormGroup>))}
        </Box>
        </Box>
     ...
     <Typography variant="subtitle2" sx={{color: "green"}}>
      ...
      {leaf_arrangement_array.map((arrangement, index) => (
        <FormGroup key={arrangement}> 
            <FormControlLabel            
            control={<Checkbox checked={checkedStateLeafArrangement[index]} onChange={() => handleOnChangeLeafArrangement(index)}/>}
            label={arrangement}/>
        </FormGroup>))}
        </Box>
        </Box>
       ...
       {!!data?.length &&  
         data.map((specie, index) => (
           <MenuItem key={index} value= {specie.plant_genera.genus_name+ ' '+specie.species_name}>
             <Link href={`/plants/${specie.species_name}`} style={{ textDecoration:'none' }}>{specie.plant_genera.genus_name+ ' '+specie.species_name}</Link>
           </MenuItem>
         ))}
     </Select>  
     </FormControl> 
