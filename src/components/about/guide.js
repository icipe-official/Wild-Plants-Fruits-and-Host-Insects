  ...
  return (
    <Container>
      <Box sx={{ marginTop: 12, justifyContent: "center" }}>
        <h2>
          <a name="usage_of_the_application" className="anchor">
            User Guide
          </a>
        </h2>
        ...
        <p>
          When using the "Plant and Fruits With insects page, individual plant
          species are generated by clicking on that species’ name. A plant data
          page contains a photo, morphology, description of the plant,
          expandable photographs, and a map showing the geographical
          distribution of the plant, as well as its fruiting phenology, the
          latter determined empirically during this project. A list of insects
          reared from the fruit is also provided.
        </p>
        <Image
        ...
        <Image
          src={`${base_path}/img/screen02a.jpg`}
          alt="No Image"
          width={1200}
          height={800}
        />
        ...
        <p className="caption">Results page generated by the query.</p>
        ...
        <h3>
          <a name="browse-insects-reared-from-fruits" className="anchor">
        ...
        <h3>
          <a name="phylogeny" className="anchor">
        ...
        <p className="caption">The alphabetically-ordered Glossary page.</p>
        <Image
